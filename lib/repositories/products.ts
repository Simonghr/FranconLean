...
export async function create(
  data: Pick<Product, 'site_id' | 'supplier' | 'name'> &
    Partial<Pick<Product, 'price' | 'pack_size' | 'target_stock' | 'zone' | 'note' | 'position' | 'current_stock' | 'temporary' | 'unit' | 'stock' | 'department'>>
): Promise<Product> {
...
export async function update(
  id: string,
  data: Partial<Pick<Product, 'supplier' | 'name' | 'price' | 'pack_size' | 'target_stock' | 'zone' | 'note' | 'position' | 'current_stock' | 'temporary' | 'unit' | 'stock' | 'department'>>
): Promise<Product> {
